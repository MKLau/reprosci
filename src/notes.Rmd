...
![Wordcloud of pre-class survey comments.](../docs/cloud_2018.png)
...
*Data Class*: Classes are specific ways that the data are organized. This determines
how the information can be indexed.
...
This is how we can refer to specific values inside of objects.

```{r, eval = TRUE}

# This is a scalar, which R will treat as a vector

1 
x <- 1
is.vector(x)

# Creating a vector and indexing the first value
...
## Activity: Wrangling some real data (10 min)
...
1. Download the firefly data from https://github.com/MKLau/reprosci/blob/master/data/FFW_Data_2016.csv
2. In the repro_example project, create a new script called "firefly.R"
3. Import the data into the script
4. Explore them using *head*, *tail*, *str* and *summary*
5. Make a plot of two of the variables and save the plot to *results*
...
Write a test to (at least partly) check that the firefly data are imported correctly.
