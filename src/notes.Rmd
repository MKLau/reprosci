...
Start a new script and write some code that creates two objects "a"
...
1. Import the data using 
2. Explore them using *head*, *tail*, *str* and *summary*
3. Make a plot of two of the variables and save the plot to *results*
