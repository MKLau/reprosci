...
8. *str* and *summary*
9. Make a plot of two of the variables and save the plot to *results*

**Make sure that your working directory is set correctly**

## Get versioning with git (5 min)
...
## Activity: Make two vectors (each of length 5) and combine them into
   a data frame (10 min)
...
1. *packrat*, *Rmarkdown* and github
