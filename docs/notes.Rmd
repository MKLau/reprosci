...
Open up the example project and run the script. 
 
# Yo, Matt, it's time to take a break!

# Anatomy of an R Script (20 min)
...
Start a new project and outline a script that will: 
...
# "Backing Up" Version Control (30 min)
...
## Activity: Setup your ecological data project as a repository (15 min)
...
## Wanna go back in time! (5 min)

# Yo, Matt, it's time to take a break!

## Software Dependencies: R Packages and CRAN *et al.* (10 min)
...
- How to work on Harvard's Odyssey super cluster
