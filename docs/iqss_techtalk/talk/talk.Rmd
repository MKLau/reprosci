...
# Opportunity = Benefaction

# Reality = The Engineering Gap

# Encapsulation and Continuous Integration

# encapsulator = Easier Capsules and CI
...
- Capsule Databases/Engines (CodeOcean, Globus)
- Continuous Integration (at the beginning)
- Scalability?
